# @discere-os/librsvg.wasm

WebAssembly port of librsvg - SVG rendering library with WebGPU acceleration and SIMD optimizations for high-performance vector graphics.

[![CI/CD](https://github.com/discere-os/discere-nucleus/actions/workflows/librsvg-wasm-ci.yml/badge.svg)](https://github.com/discere-os/discere-nucleus/actions)
[![JSR](https://jsr.io/badges/@discere-os/librsvg.wasm)](https://jsr.io/@discere-os/librsvg.wasm)
[![npm version](https://badge.fury.io/js/@discere-os%2Flibrsvg.wasm.svg)](https://badge.fury.io/js/@discere-os%2Flibrsvg.wasm)
[![License](https://img.shields.io/badge/License-LGPL--2.1-blue.svg)](COPYING.LIB)
